...
namespace CurriculumInfrastructure.Features.Subjects.GetTeacjerSubjects.CQRS.Query
{
    public class GetTeacjerSubjectsQueryHandler : IRequestHandler<GetTeacjerSubjectsQuery, CommitResults<TeacherSubjectReponse>>
    {
        ...
        public async Task<CommitResults<TeacherSubjectReponse>> Handle(GetTeacjerSubjectsQuery request, CancellationToken cancellationToken)
        {
