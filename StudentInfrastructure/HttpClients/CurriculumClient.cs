...
public class CurriculumClient
{
    ...
    public async Task<ICommitResults<SubjectBriefProgressResponse>?> SubjectsBriefProgressAsync(int Term, string? StudentId, CancellationToken cancellationToken)
